...
<div class="container" style="margin-top:90px">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="<?php echo url_for('/staff/notes/index.php'); ?>">Leads</a></li>
    ...
    <div class="container col-12 mb-4">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form class="col-sm-6" action="<?php echo url_for('/staff/notes/delete.php?id=' . h(u($note['id'])));?>" method="post">
              <?php echo display_errors($errors); ?>
              <fieldset class="form-group">
                <button class="btn btn-outline-info" type="submit">Delete</button>
              </fieldset><!-- fieldset -->
            </form>
            <a href="<?php echo url_for('/staff/notes/show.php?id=' . h(u($note['id']))); ?>">&laquo; Back to <?php echo h($note['id']);?></a>
        </div><!-- .card-body -->
      </div><!-- .card -->
